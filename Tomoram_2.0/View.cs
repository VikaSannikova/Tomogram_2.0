...
{
    class View //содержит функции визулизации томограммы
    {
        private Bitmap textureImage;
        private int VBOtexture; //хранит номер текстуры в памяти видеокарты
        public int min = 0;
        public int max = 2000;
        public void SetupView(int width, int height) //установка камеры
        {
        ...
        private int clamp(int value, int min, int max) //обрезание
        {
        ...
        public void DrawQuads(int layerNumber) //отрисовка четырехугольников, на вход текущий уровень
        {
